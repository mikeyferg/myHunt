...
SuperfeedrEngine::Engine.host = "05809b85.ngrok.io" # Your hostname (no http). Used for webhooks!
...
# Superfeedr username
SuperfeedrEngine::Engine.login = "mikeyferg"

# Token value. Make sure it has the associated rights your application needs
SuperfeedrEngine::Engine.password = "7e5bd6999b0971b89a1300355a7f0127"
